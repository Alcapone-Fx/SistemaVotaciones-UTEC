                ...
                <form name="frmDatos" action="#" method="#">
                    <div class="container-fluid">
                        <h2 style="text-align:center;">Panel de control</h2>
                            <legend>Ingresar Nuevo Votante</legend>                
                            ...
                            <div class="form-group">
                                        <div>
                                            ...
                                            <input type="password" class="form-control input-sm chat-input" name="pass" id="pass" placeholder="Escriba su Password" onkeyup="validacion('pass');" size="50" required>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <label>Confirmacion del Password:</label><br> 
                                            <input type="password" class="form-control input-sm chat-input" name="pass2" id="pass2"  placeholder="Escriba su Password" onkeyup="validacion('pass2');" size="50" required>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input type="text" class="form-control input-sm chat-input"  name="id" id="id" placeholder="Escriba ID del tipo de Usuario" onkeyup="validacion('id');" size="50" required>
                                            <span class="help-block"></span> 
                                        </div>
                                    </div>                               				
                            <div class="col-xs-12">
