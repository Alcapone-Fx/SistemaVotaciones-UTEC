...
<body onkeydown="return showKeyCode(event)">
        ...
        <%
             ...
             //if(request.getAttribute("mosTU")==null)response.sendRedirect("ControladorTipoUsuario?btnMostrar=true");
        %>
	...
	<div class="container-fluid">
       ...
       <nav class="col-md-4 col-lg-3">
        ...
        <section class="col-md-4 col-lg-9">
            <fieldset>
                <form name="frmDatos" action="ControladorTipoUsuario" method="post">
                        <h2 style="text-align:center;">Panel de control</h2>
                            <legend>Ingresar Nuevo Tipo de Usuario</legend>                
                                    ...
                                    <!--<div class="form-group">
                                        <div>
                                            <label>ID de Tipo de Usuario</label><br>
                                            <input type="text" class="form-control input-sm chat-input"  name="id" id="id" placeholder="Escriba ID del tipo de Usuario" onkeyup="validacion('id');" size="50" <%if(request.getParameter("edit")!=null){out.print("value="+i);}%> required>
            ...
            <fieldset style="margin-top: 30px">
                    ...
                    <table class="table table-striped custab">
                                <thead>
                                    ...
                                    <%
                                        if(request.getAttribute("mosTU")!=null){
                                            ArrayList<TipoUsuario> l1=new ArrayList<TipoUsuario>();
                                            l1.addAll((Collection)request.getAttribute("mosTU"));
                                            for(TipoUsuario v:l1){
                                    %>
